...
# Hacemos la prueba raw antes de la función:
...
lista_jobs = soup.find_all('div', {'class': 'w70_mB fl'})
lista_jobs

# Ahora los trabajos dentro de la lista:
...
#        # Creamos la columna de la página de la que se extrajo la información, en este caso 'Computrabajo'.
